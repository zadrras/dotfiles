...
plugins=(vi-mode colorize adb ant git brew brew-cask colored-man python safe-paste dircycle docker encode64 jira nyan osx zsh-syntax-highlighting zsh-autosuggestions)
